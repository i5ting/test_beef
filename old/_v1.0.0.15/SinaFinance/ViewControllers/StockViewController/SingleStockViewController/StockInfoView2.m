...
@interface StockInfoView2 ()
@property(nonatomic,retain)UITableView* curtableView;
-(void)initUI;

@end

@implementation StockInfoView2
{
...
//                if(oneColumn.p)
//                {
//                    oneLabel.text = [NSString stringWithFormat:@"%f", oneColumn.p];
//                }
//                
//                if(oneColumn.v)
//                {
//                    oneLabel.text = [NSString stringWithFormat:@"%f",oneColumn.v];
//                }
