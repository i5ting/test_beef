                ...
                if ([curString length]>1) {
                    ...
                    if (needFromRight) {
                        ...
                        if (![MyTool isDigtal:tempString]) {
                            ...
                            while ([MyTool isDigtal:tempString3]&&curSearchIndex>0) {
                                curSearchIndex -= 1;
